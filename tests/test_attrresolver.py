...
class AttributeResolverTest(unittest.TestCase):
    ...
    def setUp(self):
        self.resolver = res.AttributeResolver()
    ...
    def test_resolve_module_then_function(self):
        ...
        self.assertEqual(path_ti.module_name, "os.path")
    ...
    def test_resolve_module_then_attr(self):
        ...
        self.assertEqual(path_mod_ti.module_name, "os.path")

        file_mod_ti = self.resolver.resolve_to_type(path_mod_ti, "file")
        self.assertEqual(file_mod_ti.module_name, "os.path.file")
